...
c----------------------------Pressure-Function----------------------------c
       ...
       function pressure(rho_arr,f_arr,n)
       implicit real*8 (a-h,o-z)
       dimension :: f_arr(10000), rho_arr(10000)
       dimension :: coef(4,10000),caser(10000) 
       dimension :: pr(10000), pressure(10000)
       n2=n-1
        
       call dcsakm(n,rho_arr,f_arr,caser,coef)                
       do i=1,n
          dfdt = dcsder(1,rho_arr(i),n2,caser,coef)   
          pr(i) = rho_arr(i)*rho_arr(i)*dfdt
       end do
       pressure = pr
       end
